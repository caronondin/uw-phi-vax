...
# PURPOSE: Prep of DHS data for MOV analyses for Liberia Dataset
# DATE: Last updated November 15th 2022
...
for (i in 1:nrow(dt)){
  ...
  b <- sort(c(dt$age_at_bcg[i], dt$age_at_polbirth[i], 
              ...
              dt$age_at_rota2[i], dt$age_at_rota3[i], dt$age_at_mea1[i]))
...
#CAROLINE: saving all variables before dropping them 
saveRDS(dt, outputFile05a)
