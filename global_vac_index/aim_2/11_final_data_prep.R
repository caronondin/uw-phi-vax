...
# Load prepped data
dt <- as.data.table(read_rds(paste0(prepped_data_dir, "aim_2/09_merged_dataset.RDS")))
...
saveRDS(prepped_data, file = paste0(prepped_data_dir, "aim_2/10_prepped_data_for_analysis.RDS"))
