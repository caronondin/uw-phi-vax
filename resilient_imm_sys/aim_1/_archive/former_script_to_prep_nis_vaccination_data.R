...
# drop locations that are not in United States
# data1 <- data1 %>% filter(ESTIAP19!=106) # Puerto Rico from 2019 survey data  (which only exists in 2019 survey)
# data2 <- data2 %>% filter(ESTIAP19!=106) # Puerto Rico from 2019 survey data  (which only exists in 2019 survey)
# data3 <- data3 %>% filter(ESTIAP19!=106) # Puerto Rico from 2019 survey data  (which only exists in 2019 survey)
# data3 <- data3 %>% filter(ESTIAP19!=106) # Puerto Rico from 2019 survey data  (which only exists in 2019 survey)

# derive new variables on vaccination coverage for DTP, MMR, and Hep B
# ful_data$dtp_vac <- full_data$P_NUMDTP
# full_data$mmr_vac <- full_data$P_NUMMMR
